...
public class AdjustRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    private final ImageView itemimageview;
    private final TextView filtertextview;
    private String filtername;
    private int filterid;
    private Context context;
    public AdjustRecyclerViewHolder(Context context, View itemView){
        super(itemView);
