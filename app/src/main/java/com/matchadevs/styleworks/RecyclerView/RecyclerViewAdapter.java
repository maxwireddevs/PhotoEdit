...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewHolder> implements FastScrollRecyclerView.SectionedAdapter {
    ...
    public RecyclerViewAdapter(Context context, int itemResource, List<FilterItem> imagelist){
